...
equ_ellipsoide <- function(R_0_WGS84= 6378137,R_p_WGS84 = 6356752.314245179497563967,pos_xyz,hauteur){
  #
  ...
  pos_geo <- pos2geo(pos_xyz) # geographic coordinates of the given point
