...
equ_plan <- function(R_0_init = 6378137,R_p_init=6356752.314245179497563967, pos_xyz){
  #
  ...
  pos_geo_ellipsoide_local <- pos2geo(pos_xyz,R_0,R_p) # geographic coordinates of the given point, in the local ellipsoid ! (and not in the WGS84 ellipsoid !)
  ...
  n <- e^2*N
  pos_proj_sur_plan_equateur_xyz <- geo2pos(cbind(pos_geo_ellipsoide_local[1],pos_geo_ellipsoide_local[2],-(N-n)), R_0,R_p) # coordinates of the intersection between the major-normal N and the abscissa axis
